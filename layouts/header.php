...
<header class="header zi-5 position-fixed top-0 w-100" >
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        <div class="container py-lg-2">
            <a class="navbar-brand color_logo m-0 h-lg-60px h-50px" href="<?php echo f_path ?>"><img src="<?php echo f_path ?>assets/img/logos/shotbullLogo.png" alt="" class="h-100"></a>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header align-items-center">
        <h5 class="offcanvas-title h-50px" id="offcanvasRightLabel"><a href="<?php echo f_path ?>" class=""><img src="<?php echo f_path ?>assets/img/logos/shotbullLogo.png" alt="" class="h-100"></a></h5>
