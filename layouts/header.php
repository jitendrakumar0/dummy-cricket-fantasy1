...
<header class="header zi-5 position-fixed top-0 w-100" >
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        <div class="container py-2">
            <a class="navbar-brand color_logo" href="<?php echo f_path ?>"><img src="<?php echo f_path ?>assets/img/logos/logo.png" alt="" class="h-lg-50px h-md-40px h-25px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto gap-1 ">
                    <li class="nav-item"><a class="nav-link position-relative fw-bold text-theme1 fs-md-16 fs-14" href="<?php echo f_path ?>">Home</a></li>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header shadow align-items-center">
        <h5 class="offcanvas-title" id="offcanvasRightLabel"><a href="<?php echo f_path ?>" class=""><img src="<?php echo f_path ?>assets/img/logos/logo.png" alt="" class="w-70"></a></h5>
